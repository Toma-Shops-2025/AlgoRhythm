  ...
  return (
    <AppShell>
      ...
      <section className="px-6 pt-16 pb-10 text-center">
        <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-gold/30 bg-card/60 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-gold">
